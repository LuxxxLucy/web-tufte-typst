#import "../lib/tufte/tufte.typ": *

// Set page config (PDF only - HTML export doesn't support page configuration)
// Uncomment the following block when compiling to PDF:
// #set page(
//   paper: "us-letter",
...
#show: lucy-tufte.with(
  title: [Tufte CSS],
  authors: ((name: "Dave Liepmann"),),
)
...
#epigraph(
  ...
  source: [Richard P. Feynman, "What Do You Care What Other People Think?"]
)

#epigraph(
  [I do not paint things, I paint only the differences between things.],
  source: [Henri Matisse, _Henri Matisse Dessins: thèmes et variations_ (Paris, 1943), 37]
)
...
#figure(
  rect(width: 100%, height: 8cm, fill: gradient.linear(rgb("#e8e8e8"), rgb("#c0c0c0"))),
  caption: [From Edward Tufte, _Visual Display of Quantitative Information_, page 92.]
)

#marginfigure(
  rect(width: 100%, height: 5cm, fill: gradient.linear(rgb("#d0d0d0"), rgb("#a0a0a0"))),
...
#fullwidth[
  #figure(
    rect(width: 100%, height: 10cm, fill: gradient.linear(rgb("#f0f0f0"), rgb("#d0d0d0"))),
