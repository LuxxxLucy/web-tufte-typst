...
If you see anything that Tufte CSS could improve, we welcome your contribution in the form of an issue or pull request on the GitHub project: #link("https://github.com/edwardtufte/tufte-css")[tufte-css]. Please note the #link("https://github.com/edwardtufte/tufte-css#contributing")[contribution guidelines].
...
#sans[If you prefer sans-serifs, use the `sans` class. It relies on Gill Sans, Tufte's sans-serif font of choice.]

Links in Tufte CSS match the body text in color and do not change on mouseover or when clicked. Here is a #link("#")[dummy example] that goes nowhere. These links are underlined, since this is the most widely recognizable indicator of clickable text.#marginnote[Blue text, while also a widely recognizable clickable-text indicator, is crass and distracting. Luckily, it is also rendered unnecessary by the use of underlining.] 
...
#epigraphs((
  (content: [The English language . . . becomes ugly and inaccurate because our thoughts are foolish, but the slovenliness of our language makes it easier for us to have foolish thoughts.], source: [George Orwell, "Politics and the English Language"]),
...
#context {
  ...
  if output-format == "html" {
    // HTML: Use HTML elements for spacing and alignment
    html.elem("div", attrs: ("style": "margin-top: 2em; text-align: center;"))[
      #html.elem("p", attrs: ("style": "font-size: 0.9em; font-style: italic;"))[
        Content adapted from #link("https://edwardtufte.github.io/tufte-css/")[Tufte CSS] • Implemented in Typst
      ]
    ]
  } else {
    // PDF: Use Typst functions
    v(2em)
    align(center)[
